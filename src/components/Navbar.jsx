    ...
    <nav className='bg-gray-800 p-4 relative'>
      <div className='container mx-auto flex items-center justify-between relative z-10'>
        ...
        <div className='flex items-center'>
          ...
          <div className='mr-1 w-12 rounded-md hover:bg-slate-700 hover:shadow-xl active:shadow-md'>
      ...
      {isSidebarOpen && (
        <>
          <div
            className='sm:hidden fixed top-0 right-0 bottom-0 left-0 bg-gray-800 bg-opacity-75 z-50'
            onClick={toggleSidebar}
          ></div>
          <div
            className={`sm:hidden fixed top-0 right-0 bottom-0 bg-white w-64 overflow-y-auto transform ${
          ...
          >
            <div className='p-4'>
              <Link
                to='/fake-store-react/'
                className='block text-white bg-gray-800 hover:bg-gray-700 rounded-md px-3 py-2 mb-2'
              >
                Home
              </Link>
              <Link
      ...
      {/* Cart Overlay */}
      {isCartOpen && (
        <div className='fixed top-0 right-0 bottom-0 left-0 md:left-1/2 lg:left-2/3 bg-white p-4 shadow-md overflow-y-auto z-50'>
          <div className='z-50'>
