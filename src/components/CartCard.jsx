...
function CartCard({ product }) {
  const { totalPrice, setTotalPrice, ejecutarEliminar } =
  ...
  return (
    <div className='relative flex items-center h-16 my-2 p-2 border border-stone-300 rounded-md'>
      ...
      <div className='flex items-center w-3/4'>
        ...
        <div className='flex items-center w-full'> {/* grid grid-cols-2 */}
          <span className='ml-3 text-sm text-stone-500 w-3/4'>
            {truncatedTitle}
          </span>
          <span className='ml-2 text-sm w-1/4'>
            Price: ${product.price}
          </span>
        </div>
      </div>
      ...
      <div className='w-1/4'>
        ...
        <div className='absolute flex items-center bottom-0 right-0 mb-1 mr-3'>
          <button
            ...
            onClick={() => ejecutarEliminar(product.id)}
          >
            delete
          </button>
        </div>
